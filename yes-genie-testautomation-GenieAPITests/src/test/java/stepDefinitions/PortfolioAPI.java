...
public class PortfolioAPI {
    ...
    @Then("^productCategory will be LOANS \"([^\"]*)\"$")
    public void productcategory_will_be_LOANS(String arg1) throws Throwable {
    ...
    @Then("^productCategory will be OTHERS \"([^\"]*)\"$")
    public void productcategory_will_be_OTHERS(String arg1) throws Throwable {
