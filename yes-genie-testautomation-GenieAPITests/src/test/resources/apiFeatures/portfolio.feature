...
Feature: Validate portfolio APIs
  ...
  Scenario Outline: User search with valid mdmId and validate response of relationship api where customer type is individual for all the mentioned keys in examples
    Given a genie user has a relationship api to test is "http://yesgenie.com:30978/api/portfolio/"
    When a genie user passes the "996264849" as a mdmid to get the response from portfolio api where customer type is individual
  ...
  @regression
  Scenario Outline: User search with valid mdmId and validate response of relationship api where customer type is individual for all the mentioned keys in examples
    Given a genie user has a relationship api to test is "http://yesgenie.com:30978/api/customer/relationship/"
