...
Feature: Validate nba APIs
  ...
  Scenario: User validates the response code of nba api and mdmId as response where customer type is individual
    Given a genie user has a nba api to test is "http://cust360.yesgenie.com:30978/api/recommendation/view/"
  ...
  Scenario: User validates the response code of nba api and actionCode as response
    Given a genie user has a nba api to test is "http://cust360.yesgenie.com:30978/api/recommendation/configurations/mappings"
  ...
  Scenario: User validates the response code and response of blacklist api
    Given a genie user has a blacklist api to test is "http://cust360.yesgenie.com:30978/api/blacklist/reasons"
  ...
  Scenario: User validates the response code of dismissal put api where user enters reason and action
    Given a genie user has a dismissal api to test is "http://cust360.yesgenie.com:30978/api/recommendation/dismissal/"
  ...
  Scenario: User validates the response code of dismissal put api where user enters deferDate, action and recomendationDueDate
    Given a genie user has a defer api to test is "http://cust360.yesgenie.com:30978/api/recommendation/"
