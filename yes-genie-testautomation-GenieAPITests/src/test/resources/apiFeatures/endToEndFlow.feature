...
Feature: Validate end to end response from elastic search , demographics and NBA API
  ...
  Scenario Outline: This is the test to validate response upto demographics where customer type is individual
    ...
    Then a genie user has a demographic api to test is "http://cust360.yesgenie.com:30978/api/genie/demographic/"
  ...
  Scenario Outline: This is the test to validate response upto nba view api where customer type is individual and validate the response of initial c flag record
    ...
    Then a genie user has a nba api to test is "http://cust360.yesgenie.com:30978/api/genie/recommendation/view/"
  ...
  Scenario Outline: User search with valid mdmId, reference id and validate response of nba create lead api where customer type is individual for all the mentioned keys in examples
    Given a genie user has a nba api to test is "http://cust360.yesgenie.com:30978/api/genie/lead/"
  ...
  Scenario: User validates the response code of create lead without recommendation api
    Given a genie user has a create lead lineofbusinesses api to test is "http://cust360.yesgenie.com:30978/api/genie/lead/lineofbusinesses"
    ...
    And a genie user has a create lead product name api to test is "http://cust360.yesgenie.com:30978/api/genie/lead/productnames"
    ...
    And a genie user has a create lead branchcodes api to test is "http://cust360.yesgenie.com:30978/api/genie/lead/branchcodes"
    ...
    And a genie user has a nba create lead without recommendation api to test is "http://cust360.yesgenie.com:30978/api/genie/lead"
